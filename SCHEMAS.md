...
| `shortDescription` | `string` | ✅       | Short blurb of the impact work done.                                                                                                                    | maxLength: 3000, maxGraphemes: 300   |
| `description`      | `string` | ❌       | Optional longer description of the impact work done.                                                                                                    | maxLength: 30000, maxGraphemes: 3000 |
